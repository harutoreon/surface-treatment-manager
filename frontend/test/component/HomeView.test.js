...
describe('HomeView', () => {
  ...
  describe('Link Behavior', () => {
    ...
    it('各リンクのto属性に間違いがないこと', () => {
      ...
      expect(links[7].attributes('href')).toBe('#')
  ...
  describe('Icon display', () => {
    ...
    it('各アイコンにalt属性が設定されていること', () => {
      ...
      expect(icons[0].attributes('alt')).toBe('sample image')
      expect(icons[1].attributes('alt')).toBe('sample image')
      expect(icons[2].attributes('alt')).toBe('sample image')
      expect(icons[3].attributes('alt')).toBe('sample image')
      expect(icons[4].attributes('alt')).toBe('sample image')
      expect(icons[5].attributes('alt')).toBe('sample image')
      expect(icons[6].attributes('alt')).toBe('sample image')
      expect(icons[7].attributes('alt')).toBe('sample image')
      expect(icons[8].attributes('alt')).toBe('sample image')
    })
  })
})
