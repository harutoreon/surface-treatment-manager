...
#         fill_in('投稿者名', with: 'sample commenter')
#         select('品質管理部', from: 'comment_department')
...
#         expect(page).to have_selector('h6',  text: '品質管理部 : sample commenter')
...
#         expect(page).to have_selector('h3',  text: '表面処理情報')
#         expect(page).to_not have_selector('h6',  text: '品質管理部 : sample commenter')
...
#   describe '#destroy' do
#     before do
#       @comment = @sample.comments.create(commenter: 'sample commenter', department: 'department', body: 'sample comment.')
